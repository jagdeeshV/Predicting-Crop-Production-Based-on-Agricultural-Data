...
## M2a1. Most & Least Farming / cultivated Items across regions
...
print("Most Farmed / Cultivated Items: ", most_cultivated)
print("Least Farmed / Cultivated Items: ", least_cultivated,"\n") 
input("Press ENTER key to continue...")
print()

print(f"{BOLD}{NAVYBLUE}C. Graphical Representations \n{RESET}")
## M2a2.  Top 10 Farmed / Cultivated Items across Regions and years
plt.figure(figsize=(13,6))
cd.head(10).plot(kind='bar', color='plum')
plt.title("Top 10 Farmed / Cultivated Items across Regions and years") 
...
plt.title('Area, Item (Livestock/ crops) wise Higher Activity')
plt.xlabel('Area')
plt.ylabel('Value')
...
print("")
console.print("[purple]4. P r e d i c t i o n\n", justify='center')
console.print(" \n", justify='center')
input("Press ENTER key for executing streamlit application")
os.system('streamlit run Jag_Crop_proj_Predict_app.py "D:\Guvi\Crop Proj\FAOSTAT_data\FAOSTAT_Cleaned_Req.csv"')
print('')
console.print("[purple]5. EDA Report \n", justify='center')
console.print(" \n")
input("Press ENTER key to view the report...")
os.system('start  Jag_crop_EDA Report.pdf')
print('')
print('Thank you for the oppurtunity given to me to display the project')
